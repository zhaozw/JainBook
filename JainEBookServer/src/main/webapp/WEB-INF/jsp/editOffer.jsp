		...
		<div class="container">
			...
			<div class="background_body">
				...
				<div style=" clear: both; text-align: right;margin-bottom:30px;">
					<h2 class="legend" style="margin-bottom:0px;">Edit Offer</h2>
					<span style="color: black;">*indicates mandatory fields</span>
				</div>
				<div class="form-addEditLogo">
				<form:form method="POST" commandName="editOfferForm" action="editOffer.htm" enctype="multipart/form-data" cssClass="form-horizontal"> 
					...
					<div class="form-group">
            			<label  class="control-label col-xs-5"><spring:message code="offer.description.image.label.edit" /></label>
            			<div class="col-xs-3">
        			...
        			<div class="form-group">
            			<label  class="control-label col-xs-5"><spring:message code="offer.coupon.image.label.edit" /></label>
            			<div class="col-xs-3">
					...
					<div class="form-group">
            			...
            			<div class="col-xs-3">
                			<form:select path="offerType" cssClass="form-control">
                				...
                				<form:options items="${editOfferForm.offerTypes}"/> 
							</form:select> 
        			...
        			<div class="form-group">
            			<div class="col-xs-offset-5 col-xs-8">
							...
							&nbsp;<a class="btn btn-primary" href="offerDetails.htm?offerId=${sessionScope.activeOfferId}">Cancel</a>
            			</div>
        			</div>
