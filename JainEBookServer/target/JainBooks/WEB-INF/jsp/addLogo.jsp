		...
		<div class="container">
			...
			<div class="background_body">
				...
				<div style=" clear: both; text-align: right;margin-bottom:30px;">
					<h2 class="legend" style="margin-bottom:0px;">Add New Logo</h2>
					<span style="color: black;">*indicates mandatory fields</span>
				</div>
				<div class="form-addEditLogo">
				<form:form method="POST" commandName="addLogoForm" action="addLogo.htm" enctype="multipart/form-data" cssClass="form-horizontal"> 
        			...
        			<div class="form-group">
            			<label for="uploadLogo" class="control-label col-xs-5"><spring:message code="upload.image.label" /></label>
            			<div class="col-xs-3">
