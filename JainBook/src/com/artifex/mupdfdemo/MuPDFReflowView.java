	...
	public void setPage(int page, PointF size) {
		...
		mLoadHTML = new AsyncTask<Void,Void,byte[]>() {
			...
			protected void onPostExecute(byte[] result) {
				//getSettings().setFixedFontFamily(Typeface.createFromAsset(c.getAssets(), "robotobold.ttf"););
				String b64 = Base64.encodeToString(result, Base64.DEFAULT);
				loadData(b64, "text/html; charset=utf-8", "base64");
			/*	  try {
				    File myFile = new File("/sdcard/mysdfile.html");
				...
				//loadData(b64, null, null);
				//loadDataWithBaseURL(null,b64, "text/html" ,"utf-8", null);
